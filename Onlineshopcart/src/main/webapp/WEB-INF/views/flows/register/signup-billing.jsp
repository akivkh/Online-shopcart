...
<%@include file="../templates/flows-header.jsp"%>
					...
					<sf:form method="POST" class="form-horizontal" id="billingForm"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:input type="text" path="addressLineOne" class="form-control"
									placeholder="EnternAddress Line One" />
						...
						<div class="form-group">
							...
							<div class="col-md-offset-4 col-md-8">
								...
								<!-- subnmit button for moving to the confirm -->
...
<%@include file="../templates/flows-footer.jsp"%>