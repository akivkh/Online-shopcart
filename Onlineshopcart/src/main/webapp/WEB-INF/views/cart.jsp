  ...
  <c:when test="${not empty cartLines}">
  	...
  	<table id="cart" class="table table-hover table-condensed">
					...
					<tr>
							...
							<td data-th="Subtotal" class="text-center">&#8377; ${cartLinr.total}</td>
					...
					<tfoot>
						...
						<tr>
							<td><a href="#" class="btn btn-warning"><span class="glyphicon glyphicon-chebron-left"></span> Continue Shopping</a></td>
