...
<!--  self coded script for controllerProducts script -->
			...
			<div class="row carousel-holder">
					...
					<div id="carousel-example-generic" class="carousel slide"
						...
						<div class="carousel-inner">
							...
							<div class="item active">
								<img class="slide-image" src="${images}/banners/b1.png"
									alt="">
							</div>
							<div class="item">
							...
							<div class="item">
								<img class="slide-image" src="${images}/banners/b3.jpg"
									alt="">
							</div>
							<div class="item">
								<img class="slide-image" src="${images}/banners/b4.jpg"
									alt="">
							</div>
								<div class="item">
								<img class="slide-image" src="${images}/banners/b5.jpg"
									alt="">
							</div>
                ...
                <div class="row is-table-row">
                    ...
                    <div class="col-sm-4" ng-repeat="product in pCtrl.mvProducts">                    	
                        <div class="thumbnail">
                            <img ng-src="${images}/{{product.code}}.jpg"  alt="{{product.name}}"  class="landingImg" height="100px" width="100px" >
                            <h5>{{product.name}}</h5>
                            <hr/>
                            <div class="caption">
